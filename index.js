 ...
 *
 * The notification message and deployment location are configured in, `.github/build-notifier.yml`, on the target repo. There are two values that must be set in the configuration file:
 *
 ...
 *
 * @summary GitHub bot to comment on new pull requests with a link to a live demo of the requested PR.
